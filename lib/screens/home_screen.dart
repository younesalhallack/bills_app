...
class HomeScreen extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    // جلب الحسابات الكلية الموحدة بـ baseAmount من المزودات
    final netBalance = ref.watch(totalBalanceProvider);
    final totalIncome = ref.watch(totalIncomeProvider);
    final totalExpenses = ref.watch(totalExpensesProvider);

    // جلب العملة الأساسية الحالية
    final currencySettings = ref.watch(currencySettingsStreamProvider).value;
    final baseCurrency = currencySettings?.baseCurrencyCode ?? '';
